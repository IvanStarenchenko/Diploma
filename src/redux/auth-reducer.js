...
export const setAuthUserData = (customerId , email , profileLoginUser , isLogin) =>{
    return {
        type: SET_USER_DATA,
        data : {customerId , email , profileLoginUser , isLogin},
    }
} 
...
export const getMyselfAuthData = () =>  async (dispatch) =>
{
    ...
    if (responce.data.resultCode === 0) {
        ...
        let responceUser = await profileAPI.getProfile(id)
