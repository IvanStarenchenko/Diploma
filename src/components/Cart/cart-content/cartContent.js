        ...
        <section className="cart">
            <div className="cart__details">
                <div className="container container-details">
                    <h4 className="cart__title">Product Details</h4>
                ...
                <div className="cart__inner inner-cart">
                    {
                        ...
                        : props.cartContent.map(item => (
                            ...
                            <div className="inner-cart__product product-cart">
                                    ...
                                    <div className="product-cart__price" id="blue-flower-print-crop-top-price">{item.price}</div>
                                    <div className="product-cart__quantiy">
                                        <button onClick={() => {decreaseCounter(counter)}} id="decrement">-</button>
                                        <div id="counter">{counter}</div>
                                        <button onClick={() => {increaseCounter(counter)}} id="increment">+</button>
                                    </div>
