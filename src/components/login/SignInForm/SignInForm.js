...
const SignInForm = ({handleSubmit}) => {
    return (
        ...
        <div className="inner-sign__password sign-in__password">
            <label for="password">
                <span>Password</span>
            ...
            <Field className="inner-sign__input" id="passwordInput" type="password" name={"password"} component={Input}/>
            <NavLink to = {'/Reset'} className="forget">Forget your password</NavLink>
        </div>
        <button type="submit" className="inner-sign__button">Sign In</button>
        </form>
    )
}
